function [DIC,HCO3,CO3,ALK,CO2] = f_csys_h_pCO2(TC,S,pH,pco2)
% ---------------------------------------------------------------
%
%   [HCO3,CO3,DIC,ALK,CO2] = f_csys_h_pCO2(TC,S,pH,pco2)
%
...
%
%   Using their flag 101 (h and pCO2 given)
%
%   Purpose: Given two components of the CO2 system, calculate all other.
%   In this case, pH and pCO2 are given at pressure zero (surface ocean).
%
%   Input parameters:
...
% ----------- change units from mol/kg to umol/kg
